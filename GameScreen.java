...
public class GameScreen implements Screen {
    ...
    public GameScreen(Game game){
        ...
        catapult = new Catapult("catapult_main.png", 250, 210, 100, 200,physicsWorld.getWorld());
...
//        pigsList.add(new Pigs("King_pig.png", 1495, 207, 110, 100));
    ...
    public void render(float delta) {
        ...
        for (Bird bird : birdsList) {
            bird.render(batch,physicsWorld.getWorld());
        }
        for (Block blo : blockList) {
//            blo.render(batch);
        }
        for (Pigs pig : pigsList) {
            pig.render(batch,physicsWorld.getWorld());
        }
